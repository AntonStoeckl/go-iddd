...
func TestCommandHandlerWithReflectionRegister(t *testing.T) {
	Convey("Given a CommandHandler", t, func() {
		mockCustomers := new(mocks.Customers)
		commandHandler := NewCommandHandlerWithReflection(mockCustomers)
...
func TestCommandHandlerWithReflectionConfirmEmailAddress(t *testing.T) {
	Convey("Given a CommandHandler", t, func() {
		mockCustomers := new(mocks.Customers)
		commandHandler := NewCommandHandlerWithReflection(mockCustomers)
		So(commandHandler, ShouldImplement, (*shared.CommandHandler)(nil))
...
func TestCommandHandlerWithReflectionInvalidCommand(t *testing.T) {
	Convey("Given a CommandHandler", t, func() {
		mockCustomers := new(mocks.Customers)
		commandHandler := NewCommandHandlerWithReflection(mockCustomers)
		So(commandHandler, ShouldImplement, (*shared.CommandHandler)(nil))
...
func TestCommandHandlerWithReflectionUnknownCommand(t *testing.T) {
	Convey("Given a CommandHandler", t, func() {
		mockCustomers := new(mocks.Customers)
		commandHandler := NewCommandHandlerWithReflection(mockCustomers)
		So(commandHandler, ShouldImplement, (*shared.CommandHandler)(nil))
...
type unknownCommand2 struct{}

func (c *unknownCommand2) Identifier() string {
	return "unknown"
}

func (c *unknownCommand2) CommandName() string {
	return "unknown"
}
