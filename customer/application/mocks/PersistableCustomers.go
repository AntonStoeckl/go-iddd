...
func (_m *PersistableCustomers) Persist(id *values.ID, recordedEvents shared.DomainEvents) error {
...
func (_m *PersistableCustomers) Register(id *values.ID, recordedEvents shared.DomainEvents) error {
	ret := _m.Called(id, recordedEvents)
