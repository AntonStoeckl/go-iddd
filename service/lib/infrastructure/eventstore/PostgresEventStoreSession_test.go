...
// 					stream,
// 					ShouldResemble,
// 					lib.DomainEvents{event2, event3, event4},
// 				)
// 			})
//
// 			errTx = tx.Commit()
...
// 						err := session.AppendEventsToStream(
// 							streamID,
// 							lib.DomainEvents{event4, event5, event6},
// 						)
//
// 						So(err, ShouldBeNil)
//
...
// 								stream,
// 								ShouldResemble,
// 								lib.DomainEvents{event1, event2, event3, event4, event5, event6},
// 							)
//
// 							errTx = tx.Commit()
// 							So(errTx, ShouldBeNil)
...
// 						err := session.AppendEventsToStream(
// 							streamID,
// 							lib.DomainEvents{event4, event5, event6, event3}, // conflicting event last
// 						)
//
// 						Convey("It should fail", func() {
...
// /*** Test Helper Methods ***/
//
// func cleanUpArtefactsForPostgresEventStoreSession(store *eventstore.PostgresEventStore, streamID lib.StreamID) {
