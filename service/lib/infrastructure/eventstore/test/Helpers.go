...
func (someID *SomeID) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return bytes, lib.MarkAndWrapError(err, lib.ErrMarshalingFailed, "SomeID.MarshalJSON")
	}
...
func (someID *SomeID) UnmarshalJSON(data []byte) error {
	...
	if err := jsoniter.Unmarshal(data, &value); err != nil {
		return lib.MarkAndWrapError(err, lib.ErrUnmarshalingFailed, "SomeID.UnmarshalJSON")
	}
...
func (someEvent *SomeEvent) UnmarshalJSON(data []byte) error {
	...
	if err := jsoniter.Unmarshal(data, unmarshaledData); err != nil {
		return lib.MarkAndWrapError(err, lib.ErrUnmarshalingFailed, "SomeEvent.UnmarshalJSON")
	}
