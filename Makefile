...
PROTO_DIR := service/customeraccounts/infrastructure/adapter/primary/grpc
GRPC_TARGET_DIR := service/customeraccounts/infrastructure/adapter/primary/grpc
REST_GW_TARGET_DIR := service/customeraccounts/infrastructure/adapter/primary/rest
